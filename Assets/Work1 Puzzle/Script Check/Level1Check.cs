...
public class Level1Check : MonoBehaviour
{
    ...
    public static Level1Check Instance;
    ...
    void Update()
    {
        ...
        int number1 = script1.GetNumber(SlotCheck.ConnectionPoint.MiddleRight);
        int number2 = script1.GetNumber(SlotCheck.ConnectionPoint.BottomRight);
        int number3 = script2.GetNumber(SlotCheck.ConnectionPoint.MiddleLeft);
        int number4 = script2.GetNumber(SlotCheck.ConnectionPoint.BottomLeft);
        int number5 = script3.GetNumber(SlotCheck.ConnectionPoint.TopLeft);
        int number6 = script3.GetNumber(SlotCheck.ConnectionPoint.TopRight);

        if (number1 != 0 && number2 != 0 && number3 != 0 && number4 != 0 && number5 != 0 && number6 != 0)
        {
            if (number1 == number3 && number2 == number5 && number4 == number6)
            {
                allTrue = true;
